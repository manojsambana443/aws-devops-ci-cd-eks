        ...
        "Statement": [
            {
                "Effect": "Allow",
                "Principal": {
                    "Federated": "arn:aws:iam::154980000474:oidc-provider/<OIDC_PROVIDER>"
                },
                "Action": "sts:AssumeRoleWithWebIdentity",
                "Condition": {
                    "StringLike": {
                        "<OIDC_PROVIDER>:sub": "system:serviceaccount:<NAMESPACE>:emr-containers-sa-*-*-154980000474-<BASE36_ENCODED_ROLE_NAME>"
                    }
                }
            }
        ]
...
Here::
    ...
    154980000474 = AWS Account ID of the EKS cluster
